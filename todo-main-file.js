...
async function greet() {
    console.clear();
    const rainboxTitle = chalkAnimation.rainbow("Hassam's todo-list PIAIC(PIAIC202061)\n");
    await sleep();
    rainboxTitle.stop();
}
async function add() {
    let add_new_todo = inquirer.prompt({
        name: "adding",
        type: "input",
        message: chalk.redBright("hello please enter the work you want to add in todo list:  "),
    });
...
async function remove() {
    let remover_from_todo = inquirer.prompt({
        name: "remove",
        type: "input",
        message: chalk.redBright("hello please enter the work you have done and you want to delete it from the todo list:  "),
    });
